...
for m in fleet-db/migration_002_indent_serial_batches.sql fleet-db/migration_003_password_reset_otps.sql fleet-db/migration_004_vehicle_approval.sql fleet-db/migration_005_vehicle_types.sql fleet-db/migration_006_vehicle_fleetbook_fields.sql fleet-db/migration_007_fuel_indent_serial.sql fleet-db/migration_008_site_codes_sla.sql; do
  if [[ -f "$m" ]]; then
