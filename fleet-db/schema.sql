...
CREATE TABLE vehicles (
  ...
  engine_number VARCHAR(128) NULL,
  chassis_number VARCHAR(128) NULL,
  ac_type VARCHAR(16) NULL,
  gps_installed TINYINT(1) NOT NULL DEFAULT 0,
  gps_imei VARCHAR(64) NULL,
  gps_vendor VARCHAR(128) NULL,
  insurance_expiry DATE NULL,
  fitness_expiry DATE NULL,
  puc_expiry DATE NULL,
  tax_expiry DATE NULL,
  permit_expiry DATE NULL,
  form_42_47_expiry DATE NULL,
  form_49_expiry DATE NULL,
  is_active TINYINT(1) NOT NULL DEFAULT 1,
